...
// Function - when I click the start button, timer starts
var totalTime = 76;
function newQuiz() {
    questionIndex = 0;
    totalTime = 75;
...
function checkAnswer(answer) {
    ...
    if (questions[questionIndex].answer === questions[questionIndex].choices[answer]) {
        ...
        // If answer is wrong, deduct 10 second from timer
        totalTime -= 5;
        timeLeft.textContent = totalTime;
...
// type initial and store the score in local storage
function storeHighScores(event) {
    event.preventDefault();

    // Alert if initial is not enter
